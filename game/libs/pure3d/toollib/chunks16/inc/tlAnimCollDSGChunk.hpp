...
#ifndef _tlAnimCollDSGChunk_HPP_
#define _tlAnimCollDSGChunk_HPP_
...
//class referred by tlAnimCollDSGChunk.sc
class tlAnimCollDSGChunk;




class tlAnimCollDSGChunk : public tlDataChunk 
{
public:

    // Methods
    tlAnimCollDSGChunk(); 
    tlAnimCollDSGChunk(tlReadChunk16* ch); 
    tlAnimCollDSGChunk(const tlAnimCollDSGChunk& ch); 
    ~tlAnimCollDSGChunk();

    void Init();

    tlAnimCollDSGChunk& operator=(const tlAnimCollDSGChunk&); 
    ...
    virtual int SortPriority() {return tlAnimCollDSGChunk::sortPriority;}
