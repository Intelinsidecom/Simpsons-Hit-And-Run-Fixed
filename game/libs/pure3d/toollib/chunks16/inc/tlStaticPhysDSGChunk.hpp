...
#ifndef _tlStaticPhysDSGChunk_HPP_
#define _tlStaticPhysDSGChunk_HPP_
...
//class referred by tlStaticPhysDSGChunk.sc
class tlStaticPhysDSGChunk;




class tlStaticPhysDSGChunk : public tlDataChunk 
{
public:

    // Methods
    tlStaticPhysDSGChunk(); 
    tlStaticPhysDSGChunk(tlReadChunk16* ch); 
    tlStaticPhysDSGChunk(const tlStaticPhysDSGChunk& ch); 
    ~tlStaticPhysDSGChunk();

    void Init();

    tlStaticPhysDSGChunk& operator=(const tlStaticPhysDSGChunk&); 
    ...
    virtual int SortPriority() {return tlStaticPhysDSGChunk::sortPriority;}
