...
#ifndef _tlEntityDSGChunk_HPP_
#define _tlEntityDSGChunk_HPP_
...
//class referred by tlEntityDSGChunk.sc
class tlEntityDSGChunk;




class tlEntityDSGChunk : public tlDataChunk 
{
public:

    // Methods
    tlEntityDSGChunk(); 
    tlEntityDSGChunk(tlReadChunk16* ch); 
    tlEntityDSGChunk(const tlEntityDSGChunk& ch); 
    ~tlEntityDSGChunk();

    void Init();

    tlEntityDSGChunk& operator=(const tlEntityDSGChunk&); 
    ...
    virtual int SortPriority() {return tlEntityDSGChunk::sortPriority;}
