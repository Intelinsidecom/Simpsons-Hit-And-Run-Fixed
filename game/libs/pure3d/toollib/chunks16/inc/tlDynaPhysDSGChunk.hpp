...
#ifndef _tlDynaPhysDSGChunk_HPP_
#define _tlDynaPhysDSGChunk_HPP_
...
//class referred by tlDynaPhysDSGChunk.sc
class tlDynaPhysDSGChunk;




class tlDynaPhysDSGChunk : public tlDataChunk 
{
public:

    // Methods
    tlDynaPhysDSGChunk(); 
    tlDynaPhysDSGChunk(tlReadChunk16* ch); 
    tlDynaPhysDSGChunk(const tlDynaPhysDSGChunk& ch); 
    ~tlDynaPhysDSGChunk();

    void Init();

    tlDynaPhysDSGChunk& operator=(const tlDynaPhysDSGChunk&); 
    ...
    virtual int SortPriority() {return tlDynaPhysDSGChunk::sortPriority;}
