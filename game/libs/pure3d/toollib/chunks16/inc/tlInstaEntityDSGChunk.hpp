...
#ifndef _tlInstaEntityDSGChunk_HPP_
#define _tlInstaEntityDSGChunk_HPP_
...
//class referred by tlInstaEntityDSGChunk.sc
class tlInstaEntityDSGChunk;




class tlInstaEntityDSGChunk : public tlDataChunk 
{
public:

    // Methods
    tlInstaEntityDSGChunk(); 
    tlInstaEntityDSGChunk(tlReadChunk16* ch); 
    tlInstaEntityDSGChunk(const tlInstaEntityDSGChunk& ch); 
    ~tlInstaEntityDSGChunk();

    void Init();

    tlInstaEntityDSGChunk& operator=(const tlInstaEntityDSGChunk&); 
    ...
    virtual int SortPriority() {return tlInstaEntityDSGChunk::sortPriority;}
